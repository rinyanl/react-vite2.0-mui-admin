            ...
            >
                <Toolbar>
                    ...
                    >
                        <IconButton
                            ...
                            sx={{
                                width: '38px',
                                height: '38px',
                                border: `1px solid ${React.$theme.background[200]}`,
                                borderRadius: '4px',
                            }}
                        >
                            <SvgIcon name={React.$theme.mode === 'dark' ? 'menu' : 'menu-l'} />
                    ...
                    >
                        ...
                        >
                            {routeMap.map((m, i) => {
                                return (
                                    <NavLink to={m.path} key={i}>
                                        <ListItemButton sx={{ color: React.$theme.text[900] }}>
                                            <ListItemIcon sx={{ minWidth: 38 }}>
                                                {React.$theme.mode === 'dark'
                                                    ? tabslIcon[i]
                                                    : tabsIcon[i]}
                                            </ListItemIcon>
                                            <ListItemText
                            ...
                            >
                                <ListItemIcon sx={{ minWidth: 38 }}>
                                    <SvgIcon
                                        name={React.$theme.mode === 'dark' ? 'dark' : 'light'}
                                    />
                            ...
                            >
                                <ListItemIcon sx={{ minWidth: 38 }}>
                                    ...
                                    <SvgIcon
                                        ...
                                        name={
                                            React.$theme.mode === 'dark' ? 'loginout-l' : 'loginout'
                                        }
                                    />
                                </ListItemIcon>
                                <ListItemText
                    ...
                    <Breadcrumbs
                        ...
                        sx={{ flexGrow: 1, display: { xs: 'none', md: 'block', lg: 'block' } }}
                    >
                    ...
                    >
                        <SvgIcon name={React.$theme.mode === 'dark' ? 'dark' : 'light'} />
                    </IconButton>
                    <Box
                        sx={{
                            display: { xs: 'none', md: 'block', lg: 'block' },
                    ...
                    >
                        <MenuItem
                            ...
                            sx={{
                                background:
                                    React.$theme.mode === 'dark'
                                        ? React.$theme.background[100]
                                        : React.$theme.background[50],
                                fontSize: 14,
                            }}
                        >
                            <SvgIcon
                                style={{ marginRight: '8px', marginBottom: '2px' }}
                                name={React.$theme.mode === 'dark' ? 'loginout-l' : 'loginout'}
                            />
